...
interface GreeterSubInterface extends ethers.utils.Interface {
  functions: {
...
export class GreeterSub extends BaseContract {
  ...
  callStatic: {
    ...
    setAge(_age: BigNumberish, overrides?: CallOverrides): Promise<void>;
  };
